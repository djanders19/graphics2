...
int main(int argc, char *argv[]) {
    ...
    // midpoints of wings:
    point_set( &v[16],  2.5, 0,  2, 1);
    point_set( &v[17],  0, 0,  2, 1);
    point_set( &v[18], -2.5, 0,  2, 1);

    point_set( &v[19],  2.5, 0, -2, 1);
    point_set( &v[20],  0, 0, -2, 1);
    point_set( &v[21], -2.5, 0, -2, 1);
    ...
    point_copy( &tv[0], &v[8] );
    point_copy( &tv[1], &v[9] );
    point_copy( &tv[2], &v[19] );
    point_copy( &tv[3], &v[10] );
    point_copy( &tv[4], &v[11] );
    point_copy( &tv[5], &v[21] );

    polygon_set(&side[6], 6, tv);

    // Draw right wing
    point_copy( &tv[0], &v[12] );
    point_copy( &tv[1], &v[13] );
    point_copy( &tv[2], &v[16] );
    point_copy( &tv[3], &v[14] );
    point_copy( &tv[4], &v[15] );
    point_copy( &tv[5], &v[18] );

    polygon_set(&side[7], 6, tv);

    // right support
    point_copy( &tv[0], &v[1] );
    point_copy( &tv[1], &v[2] );
    point_copy( &tv[2], &v[20] );
    point_copy( &tv[3], &v[20] );
    ...
    point_copy( &tv[0], &v[5] );
    point_copy( &tv[1], &v[6] );
    point_copy( &tv[2], &v[17] );
    point_copy( &tv[3], &v[17] );
    ...
    for (int t=0; t<nFrames; t++) {
        ...
        sprintf(filename, "tie-fighter-%04d.ppm", t );
